...
$uid = $_SESSION['uid'];
$message = "";
if(!isset($_GET['user']) || !userExists($con, $_GET['user']) || $_GET['user']==$uid){
...
$cnameQuery = "SELECT `cname` FROM company WHERE cid=$uid";
                            ...
                            while ($msgData = mysqli_fetch_array($msgResult)) {
                                if ($msgData['uids'] == $uid) {
                                    ...
                                    <div class="msg-sent">
                                        ...
                                        <br>
                                        <small>Messaging as company: <b><?php echo $cname;?></b> Send time: <?php echo $msgData['sendtime']; ?> </small>
                                    </div>
                                    <?php
                                } else {
                                    ?>
                                    <div class="msg-received">
                                        <?php echo htmlspecialchars($msgData['msg']); ?>
                                        <br>
                                        <small>From: <b><?php echo $name;?></b> Send time: <?php echo $msgData['sendtime']; ?></small>
                                    </div>
                                    <?php
                                }
                            }
